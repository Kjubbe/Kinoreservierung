...
public class KinoMain {
    ...
    // other:
    // the proceed JButton disables all following tabs, this is because of the design of the tabs with the build function, but could be better in future projects (for project desc. pdf)
