...
public class KinoController extends KeyAdapter implements ActionListener, ItemListener, ChangeListener {
    ...
    /**
     * invoked from event advises model to time based on the action command, updates
     * view
     * 
    ...
    /**
     * invoked from event advises model to change time based on the action command,
     * updates view
     * 
     * @param cmd action command from the event
     */
    ...
    /**
     * invoked from event advises model to change seats based on the selection and
     * command, updates view
     * 
    ...
    /**
     * invoked from event, gets input from JTextFields from the view, advises model
     * to set license plates, updates view
     */
    ...
    /**
     * invoked from event, gets value from all SpinnerModels from the view, advises
     * model to set caterings, updates view
     */
    ...
    /**
     * invoked from event, when user wants to place the order, advises model to
     * create an order and reset, updates and advises view to finish
     */
